		...
		<section id="cp" class="line center grid">
			<header class="grid1-3">
				...
				<div>
					...
					<a href="http://rsf-persan.org">
						<img class="w150p" src="http://rsf-persan.org/local/cache-vignettes/L293xH100/siteon0-20864.jpg" alt="logo RSF"/>
					</a>
					<div class="grid">
				...
				<h1 class="mod">
					<a dir="RTL" href="ar-index2014.php">رده‌بندی جهانی آزادی مطبوعات ٢٠١٤</a>
				</h1>
