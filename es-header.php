	...
	<body class="mode2d">
		...
		<section id="cp" class="line center grid">
			<header class="mod grid3-1">
				<h1 class="mod">
					<a href="es-index2014.php">CLASIFICACIÓN MUNDIAL<br/> 2014</a>
				</h1>
				...
				<div class="grid">
					...
					<a href="http://rsf.org">
						<img class="w150p" src="http://fr.rsf.org/squelettes/img/es/logo-es.png" alt="logo RSF"/>
					</a>
		...
		<section id="cp" class="line center">	
			...
			<ul class="grid6">
				...
				<li id="ameriques" class="mod left shortText"><a href="es-americas.php#">América</a></li>
				<li id="mo" class="mod left"><a href="es-middle-east.php">África del Norte</br> y Oriente Medio</a></li>
